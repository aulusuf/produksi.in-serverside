...
db.user_productAssignment = require('../models/user_productAssignment.model')(sequelize, Sequelize)
...
//     as: 'products'
// })
db.product.belongsTo(db.category, {             //1 category many product
    foreignKey: 'categoryId',
    as: 'categories'
})
db.product.belongsTo(db.unit, {                 //1 unit many product
    foreignKey: 'unitId',
    as: 'units'
})
db.product.belongsToMany(db.material, {         //many category many product
    through: 'products_materials',
    foreignKey: 'productId'
})
db.material.belongsToMany(db.product, {         //many product many material
    through: 'products_materials',
    foreignKey: 'materialId',
})
db.material.belongsTo(db.type, {                //1 type many material
    foreignKey: 'typeId'
})
db.material.belongsTo(db.unit, {                //1 unit many material
    foreignKey: 'unitId',
    as: 'units'
})
...
db.user.belongsToMany(db.product_assignment, {  // many product assignments many user
